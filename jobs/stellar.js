...
const updateBalance = async (address) => {
  console.log('checking xlm balance for', address)
  await runWithPuppeteer(async (page) => {
    await page.goto(`https://blockchair.com/stellar/address/${address}`)
    ...
    if (scrapeRes) {
      ...
      await Coin.query()
        ...
        .where({ address, name: 'stellar' })
      console.log('updated xlm balance', { balance })
    }
  })
}
